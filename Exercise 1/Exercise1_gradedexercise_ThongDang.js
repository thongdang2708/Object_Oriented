    ...
    roomWithNothing().then(response => {
        if (response === 'Look Around') {
            ...
            linkBetweenRoomsinentrance().then(vastaus => {
                if (vastaus === 'Hallway') {
                        // hallwayArea();
                        for (let aj=0;aj<inhallwaytwo.length;aj++) {
                            player.attackPlayer(inhallwaytwo[aj])
            ...
            if (response === 'Attack') {
                    ...
                    if (player.updateEnemyBlood() > 0) {
                        ...
                        if (inhallway[as].name === 'rat')
                            ...
                            if (traloi === 'entrance') {
                                ...
                                for (let an=0;an<inchambertwo.length;an++) {
                                    player.attackPlayer(inchambertwo[an])
               ...
               linkBetweenRoomsinHallWay().then(link => {
                    if (link === 'entrance') {
                        ...
                        for (let am=0;am<inchamberthree.length;am++) {
                            player.attackPlayer(inchamberthree[am])
                          ...
                          if (doithoai === 'Look Around') {
                            ...
                            linkBetweenRoomsinHallWay().then(linkki => {
                             if (linkki === 'entrance') {
                                    ...
                                    for (let aw=0;aw<inchamberfour.length;aw++) {
                                        player.attackPlayer(inchamberfour[aw])
            ...
            for (let ad=0;ad<inchamber.length;ad++) {
                            ...
                            inchamber.splice(as,1);}
                               ...
                               roomWithNothing().then(vastaus => {
                                ...
                                console.log('Congratulations. You are in the final portal! You made through the dungeons!');
                                    ...
                                    for (let aer=0;aer<inhallwayfour.length;aer++) {
                                        player.attackPlayer(inhallwayfour[aer])
                ...
                linkBetweenRoomsinChamber().then(link => {
                                ...
                                console.log('Congratulations. You are in the final portal! You made through the dungeons!');
                                    ...
                                    for (let ap=0;ap<inhallwaythree.length;ap++) {
                                        player.attackPlayer(inhallwaythree[ap])
